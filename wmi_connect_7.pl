...
my @computers = ("10.101.10.107", "10.101.10.106", "10.101.10.237");

# Connect to each system's CimV2 repository in turn.
for my $computer( @computers ){
my $wmi_repos = Win32::OLE->GetObject("winmgmts:{impersonationLevel=impersonate,(security)}!\\\\$computer\\root\\CIMV2")
